...
- [ ] **A3b — Remaining ~20 utility stubs** (merge/split txt/word/pptx/image/excel family, xls/xml legacy variants, svg-to-jpg/webp, docx-to-txt, json-to-xlsx, xlsx-to-json, csv-to-pdf, xls-to-pdf): give each a compact but genuinely unique 150–200 word section (utility pages don't warrant padded 300-word essays — quality gate over word count), or consolidate where truly redundant. Also file-converter pillar page (0 article words).
