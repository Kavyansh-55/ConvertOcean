...
const rawTools: ToolData[] = [
  ...
  },
  {
    ...
    quickAnswer: 'To convert Excel to JSON, select an .xlsx workbook above and download an array of objects — the header row becomes the keys and each row becomes one object. It is the direct route from a spreadsheet a colleague maintains into code, a fixture file, or a NoSQL import. Everything is parsed in your browser, so customer lists and financial exports never leave your device.',
    icon: '⚙️',
    category: 'Excel Converter',
    categorySlug: 'excel-converter',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To convert a legacy .xls workbook to JSON, select it above and download an array of objects, with the header row supplying the keys and each spreadsheet row becoming one object. It is the quickest route from an old Excel export into application code, an API fixture, or a document database. The workbook is parsed in your browser and never uploaded.',
    icon: '⚙️',
    category: 'Excel Converter',
    categorySlug: 'excel-converter',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To merge Excel files, add two or more .xlsx, .xls, or .csv files above and download a single workbook containing every source sheet. Sheet names are preserved and de-duplicated where they collide, so nothing is silently overwritten. It suits combining monthly exports or per-region reports into one file. All parsing and rebuilding happens in your browser — the spreadsheets are never sent anywhere.',
    icon: '📊',
    category: 'Excel Converter',
    categorySlug: 'excel-converter',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To split a PowerPoint, add your .pptx above and choose either to break every slide into its own presentation, or to extract custom ranges such as 1-5, 8, 11-13. Extracted slides keep their layouts, media, and speaker notes at original quality. Legacy .ppt is not supported — save it as .pptx first. The split runs entirely in your browser.',
    icon: '✂️',
    category: 'Document Tools',
    categorySlug: 'document-tools',
    faqs: [
