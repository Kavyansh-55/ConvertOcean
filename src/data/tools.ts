...
const rawTools: ToolData[] = [
  ...
  },
  {
    ...
    quickAnswer: 'To convert CSV to JSON, upload a .csv file above — each spreadsheet row becomes a JSON object, with the column headers as keys, in one structured array. Parsing runs entirely in your browser, which makes it safe for confidential data exports, API fixtures, and configuration files.',
    icon: '⚙️',
  ...
  },
  {
    ...
    quickAnswer: 'To convert JSON to CSV, upload a JSON array of objects and the tool flattens it into a comma-separated spreadsheet — object keys become column headers and each object becomes a row. Conversion happens client-side in your browser, so API responses and database exports are never sent to a server.',
    icon: '⚙️',
    category: 'Developer Tools',
    categorySlug: 'developer-tools',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To convert Excel to CSV, upload an .xlsx or .xls workbook above and download the first sheet as a clean, comma-separated CSV that any database, script, or tool can read. Values with commas or quotes are properly escaped. It is ideal for data imports and pipelines. Conversion happens entirely in your browser, with nothing uploaded.',
    icon: '📊',
    category: 'Excel Converter',
    categorySlug: 'excel-converter',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To convert PNG to JPG, upload your PNG above and download the JPG. The tool flattens any transparency onto a white background — JPG has no transparent areas — and compresses the image to cut file size. Choose JPG for photos and upload limits; keep PNG for logos or graphics that need transparency. Nothing is uploaded.',
    icon: '🖼️',
  ...
  },
  {
    ...
    quickAnswer: 'To convert JPG to PNG, upload your JPG above and download a lossless PNG. PNG avoids the generation loss JPG adds on every save, so it suits editing, screenshots, and images with sharp text or lines. Expect a larger file, since PNG stores every pixel exactly. The conversion runs entirely in your browser.',
    icon: '🖼️',
    category: 'Image Tools',
    categorySlug: 'image-tools',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To convert PNG to WebP, upload your PNG above and download a WebP that is typically 25–35% smaller at similar quality, with transparency preserved. WebP is supported by every modern browser and speeds up page loads, making it the better choice for web images. The conversion runs entirely on your device.',
    icon: '🖼️',
    category: 'Image Tools',
    categorySlug: 'image-tools',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To extract text from an image, upload a JPG, PNG, or WebP above — the built-in OCR engine converts printed text into editable, copyable plain text in your browser. Clear, high-resolution images of printed fonts give the best accuracy; handwriting is significantly less reliable. No image ever leaves your device.',
    icon: '🔍',
    category: 'Image Tools',
    categorySlug: 'image-tools',
    faqs: [
  ...
  },
  {
    ...
    quickAnswer: 'To split a PDF, upload it above and choose the pages or ranges to extract — each selection compiles into its own PDF file. Splitting runs entirely client-side in your browser, so extracting pages from confidential contracts or reports involves no server uploads and works offline once loaded.',
    icon: '🥞',
    category: 'PDF Tools',
    categorySlug: 'pdf-tools',
    faqs: [
